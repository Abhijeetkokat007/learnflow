...
const Navbar = () => {
  ...
  return (
    <nav className=" flex justify-between items-center fixed z-50 w-full nav-bg  px-6 py-2 lg:px-10 ">
      ...
      <div className="flex justify-center items-center text-[20px] font-bold  gap-5 text-black dark:text-white">
      <div className="cursor-pointer h-text-green">Home </div>
      <div className=" cursor-pointer h-text-green">About</div>
      <div className=" cursor-pointer h-text-green">
        Videos
      </div>
      <div className="cursor-pointer h-text-green">
        Document
